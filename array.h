...
namespace array {
	...
	void ShuffleArray(int arr[100], int arrLength)
	{
		for (int i = 0; i < arrLength; i++)
		{
			my::MySwap(arr[randoms::RandomNumber(1, arrLength) - 1], arr[randoms::RandomNumber(1, arrLength) - 1]);
		}
	}
	...
	void InputUserNumbersInArray(int arr[100], int& arrLength)
	{
		...
		do
		{
			AddArrayElement(input::ReadNumber(), arr, arrLength);
